    ...
    if(mouseDown){
      ...
      if(obj == null){
        ...
        if(obj.id == "pointer1"){
         ...
         angleAcontainer.innerHTML = udatedAngleA; angleBcontainer.innerHTML = udatedAngleB; angleDcontainer.innerHTML = udatedAngleD; 
         angleAcontainer.style.top = (pos.top-25)+"px";
         angleAcontainer.style.left = (pos.left+10)+"px";
         ...
         angleAcontainer.innerHTML = udatedAngleA; angleBcontainer.innerHTML = udatedAngleB; angleCcontainer.innerHTML = udatedAngleC; 
         angleBcontainer.style.top = (pos.top+25)+"px";
         angleBcontainer.style.left = (pos.left-10)+"px";
          ...
          console.log("udatedAngleA--->",udatedAngleA , "udatedAngleB--->",udatedAngleB , "udatedAngleC---->",udatedAngleC)
         angleDcontainer.innerHTML = udatedAngleD; angleBcontainer.innerHTML = udatedAngleB; angleCcontainer.innerHTML = udatedAngleC; 
         angleCcontainer.style.top = (pos.top-25)+"px";
         angleCcontainer.style.left = (pos.left-50)+"px";
          ...
          console.log("udatedAngleA--->",udatedAngleA , "udatedAngleB--->",udatedAngleB , "udatedAngleC---->",udatedAngleC)
          angleAcontainer.innerHTML = udatedAngleA; angleCcontainer.innerHTML = udatedAngleC; angleDcontainer.innerHTML = udatedAngleD;
         angleDcontainer.style.top = (pos.top-70)+"px";
         angleDcontainer.style.left = (pos.left-20)+"px";
...
pointer1 = createCircleOnCanvas(circle.left - circle.radius , circle.top , 5 , "red" ,"red" ,true, "pointer1");
...
pointer4 = createCircleOnCanvas(circle.left , circle.top + circle.radius , 5 , "red" , "red" , true, "pointer4");
