...
var canvasPdf = {
    ...
    fonts: {
        'Hobo': {
            src: '../../pdftool/font/hobo-webfont.ttf'
        },
        'segoePrint': {
            src: '../../pdftool/font/segeo-print-webfont.ttf'
        },
        'segoePrint-bold': {
            src: '../../pdftool/font/Segoe-Print-Bold.ttf'
        },
        'smileymonster': {
            src: '../../pdftool/font/smileymonster.ttf'
        },
        'Arial': {
            src: '../../pdftool/font/Arial.ttf'
        },
        'Arial-bold': {
            src: '../../pdftool/font/Arial-Bold.ttf'
        },
        'Arial-italic': {
            src: '../../pdftool/font/Arial-Italic.ttf'
        },
        'Arial-bold-italic': {
            src: '../../pdftool/font/Arial-Bold-Italic.ttf'
        },
        'Georgia': {
            src: '../../pdftool/font/Georgia.ttf'
        },
        'Georgia-bold': {
            src: '../../pdftool/font/Georgia-Bold.ttf'
        },
        'Georgia-italic': {
            src: '../../pdftool/font/Georgia-Italic.ttf'
        },
        'Georgia-bold-italic': {
            src: '../../pdftool/font/Georgia-Bold-Italic.ttf'
        },
        'TimesNewRoman': {
            src: '../../pdftool/font/times-new-roman.ttf'
        },
        'Cambria Math': {
            src: '../../pdftool/font/CambriaMath.ttf'
        }
    ...
    load: function (callback) {
        ...
        loadScript('../pdftool/pdfkit.standalone.js', function () {
            loadScript('../pdftool//blob-stream.js', function () {
                loadScript('../pdftool//canvas2pdf2.js', function () {
